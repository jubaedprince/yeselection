...
<div>
    <div class="col-md-12">
      ...
      <div class="row">
        ...
        <div class="col-md-1 heading">Class studied in 2016-2017:</div>
        <div class="col-md-3">'.  $request->input('classStudiedIn20162017', '-') .'</div>
      ...
      <div class="row">
        ...
        <div class="col-md-1 heading">Percentage marks in 2016-2017:</div>
        <div class="col-md-3">'.  $request->input('percentageMarksIn20162017', '-') .'</div>
      ...
      <div class="row">
        <div class="col-md-1 heading">Name of Workplace:</div>
        <div class="col-md-3">'.  $request->input('fatherNameOfWorkplace', '-') .'</div>
      ...
      <div class="row">
        <div class="col-md-1 heading">Name of Workplace:</div>
        <div class="col-md-3">'.  $request->input('motherNameOfWorkplace', '-') .'</div>
        <div class="col-md-8" ></div>
      </div>
      <div class="row">
      ...
      <div class="row tall">
        ...
        $name = 'YES Application Form 2018-19 (Applicant ID: ' . $request->input('unique_id', '-') . ')';
